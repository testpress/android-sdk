...
public class StreamDao extends AbstractDao<Stream, Long> {
    ...
    public static class Properties {
        ...
        public final static Property DashUrl = new Property(3, String.class, "dashUrl", false, "DASH_URL");
        public final static Property WidevineLicenseUrl = new Property(4, String.class, "widevineLicenseUrl", false, "WIDEVINE_LICENSE_URL");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"STREAM\" (" + //
                ...
                "\"URL\" TEXT," + // 2: url
                "\"DASH_URL\" TEXT," + // 3: dashUrl
                "\"WIDEVINE_LICENSE_URL\" TEXT," + // 4: widevineLicenseUrl
    ...
    public Stream readEntity(Cursor cursor, int offset) {
        Stream entity = new Stream( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // dashUrl
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // widevineLicenseUrl
    ...
    public void readEntity(Cursor cursor, Stream entity, int offset) {
        ...
        entity.setDashUrl(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setWidevineLicenseUrl(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
