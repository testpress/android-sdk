...
public class ContentDao extends AbstractDao<Content, Long> {
    ...
    public static class Properties {
        ...
        public final static Property CourseId = new Property(33, Long.class, "courseId", false, "COURSE_ID");
        public final static Property ChapterId = new Property(34, Long.class, "chapterId", false, "CHAPTER_ID");
        public final static Property VideoConferenceId = new Property(35, Long.class, "videoConferenceId", false, "VIDEO_CONFERENCE_ID");
        public final static Property LiveStreamId = new Property(36, Long.class, "liveStreamId", false, "LIVE_STREAM_ID");
        public final static Property HtmlId = new Property(37, Long.class, "htmlId", false, "HTML_ID");
        public final static Property VideoId = new Property(38, Long.class, "videoId", false, "VIDEO_ID");
        public final static Property AttachmentId = new Property(39, Long.class, "attachmentId", false, "ATTACHMENT_ID");
        public final static Property ExamId = new Property(40, Long.class, "examId", false, "EXAM_ID");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CONTENT\" (" + //
                ...
                "\"COURSE_ID\" INTEGER," + // 33: courseId
                "\"CHAPTER_ID\" INTEGER," + // 34: chapterId
                "\"VIDEO_CONFERENCE_ID\" INTEGER," + // 35: videoConferenceId
                "\"LIVE_STREAM_ID\" INTEGER," + // 36: liveStreamId
                "\"HTML_ID\" INTEGER," + // 37: htmlId
                "\"VIDEO_ID\" INTEGER," + // 38: videoId
                "\"ATTACHMENT_ID\" INTEGER," + // 39: attachmentId
                "\"EXAM_ID\" INTEGER);"); // 40: examId
    }
    ...
    public Content readEntity(Cursor cursor, int offset) {
        Content entity = new Content( //
            ...
            cursor.isNull(offset + 33) ? null : cursor.getLong(offset + 33), // courseId
            cursor.isNull(offset + 34) ? null : cursor.getLong(offset + 34), // chapterId
            cursor.isNull(offset + 35) ? null : cursor.getLong(offset + 35), // videoConferenceId
            cursor.isNull(offset + 36) ? null : cursor.getLong(offset + 36), // liveStreamId
            cursor.isNull(offset + 37) ? null : cursor.getLong(offset + 37), // htmlId
            cursor.isNull(offset + 38) ? null : cursor.getLong(offset + 38), // videoId
            cursor.isNull(offset + 39) ? null : cursor.getLong(offset + 39), // attachmentId
            cursor.isNull(offset + 40) ? null : cursor.getLong(offset + 40) // examId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Content entity, int offset) {
        ...
        entity.setCourseId(cursor.isNull(offset + 33) ? null : cursor.getLong(offset + 33));
        entity.setChapterId(cursor.isNull(offset + 34) ? null : cursor.getLong(offset + 34));
        entity.setVideoConferenceId(cursor.isNull(offset + 35) ? null : cursor.getLong(offset + 35));
        entity.setLiveStreamId(cursor.isNull(offset + 36) ? null : cursor.getLong(offset + 36));
        entity.setHtmlId(cursor.isNull(offset + 37) ? null : cursor.getLong(offset + 37));
        entity.setVideoId(cursor.isNull(offset + 38) ? null : cursor.getLong(offset + 38));
        entity.setAttachmentId(cursor.isNull(offset + 39) ? null : cursor.getLong(offset + 39));
        entity.setExamId(cursor.isNull(offset + 40) ? null : cursor.getLong(offset + 40));
     }
