...
/**
 * Master of DAO (schema version 86): knows all DAOs.
 */
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        UserUploadedFileDao.createTable(db, ifNotExists);
        ...
        InstallmentPlanDao.createTable(db, ifNotExists);
        InstallmentDao.createTable(db, ifNotExists);
        UserInstallmentPlanDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        UserUploadedFileDao.dropTable(db, ifExists);
        ...
        InstallmentPlanDao.dropTable(db, ifExists);
        InstallmentDao.dropTable(db, ifExists);
        UserInstallmentPlanDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(UserUploadedFileDao.class);
        ...
        registerDaoClass(InstallmentPlanDao.class);
        registerDaoClass(InstallmentDao.class);
        registerDaoClass(UserInstallmentPlanDao.class);
    }
