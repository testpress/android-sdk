...
public class ReviewQuestionTranslationDao extends AbstractDao<ReviewQuestionTranslation, Long> {
    ...
    public static class Properties {
        ...
        public final static Property DirectionId = new Property(5, Long.class, "directionId", false, "DIRECTION_ID");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"REVIEW_QUESTION_TRANSLATION\" (" + //
                ...
                "\"DIRECTION_ID\" INTEGER," + // 5: directionId
    ...
    protected final void bindValues(DatabaseStatement stmt, ReviewQuestionTranslation entity) {
        ...
        if (directionId != null) {
            stmt.bindLong(6, directionId);
        }
 
        IntegerList answerIds = entity.getAnswerIds();
        if (answerIds != null) {
            stmt.bindString(7, answerIdsConverter.convertToDatabaseValue(answerIds));
        }
    ...
    public ReviewQuestionTranslation readEntity(Cursor cursor, int offset) {
        ReviewQuestionTranslation entity = new ReviewQuestionTranslation( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5), // directionId
            cursor.isNull(offset + 6) ? null : answerIdsConverter.convertToEntityProperty(cursor.getString(offset + 6)), // answerIds
    ...
    public void readEntity(Cursor cursor, ReviewQuestionTranslation entity, int offset) {
        ...
        entity.setDirectionId(cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5));
        entity.setAnswerIds(cursor.isNull(offset + 6) ? null : answerIdsConverter.convertToEntityProperty(cursor.getString(offset + 6)));
