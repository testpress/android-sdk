...
public class Exam implements android.os.Parcelable {
    ...
    private Boolean enableMindsetReflections;

    @Convert(converter = in.testpress.database.ReflectionFormConverter.class, columnType = String.class)
    private ReflectionForm preExamReflectionForm;
    ...
    public Exam(String totalMarks, String url, Long id, Integer attemptsCount, Integer pausedAttemptsCount, String title, String description, String startDate, String endDate, String duration, Integer numberOfQuestions, String negativeMarks, String markPerQuestion, Integer templateType, Boolean allowRetake, Boolean allowPdf, Boolean showAnswers, Integer maxRetakes, String attemptsUrl, String deviceAccessControl, Integer commentsCount, String slug, String selectedLanguage, Boolean variableMarkPerQuestion, Integer passPercentage, Boolean enableRanks, Boolean showScore, Boolean showPercentile, StringList categories, Boolean isDetailsFetched, Boolean isGrowthHackEnabled, String shareTextForSolutionUnlock, Boolean showAnalytics, String instructions, Boolean hasAudioQuestions, String rankPublishingDate, Boolean enableQuizMode, Boolean disableAttemptResume, Boolean allowPreemptiveSectionEnding, String examDataModifiedOn, Boolean isOfflineExam, Long graceDurationForOfflineSubmission, Boolean enableExamWindowMonitoring, Boolean enableMindsetReflections, ReflectionForm preExamReflectionForm) {
        ...
        this.enableMindsetReflections = enableMindsetReflections;
        this.preExamReflectionForm = preExamReflectionForm;
    }
    ...
    public Boolean getEnableMindsetReflections() {
        return enableMindsetReflections;
    }

    public void setEnableMindsetReflections(Boolean enableMindsetReflections) {
        this.enableMindsetReflections = enableMindsetReflections;
    }

    public ReflectionForm getPreExamReflectionForm() {
        return preExamReflectionForm;
    }

    public void setPreExamReflectionForm(ReflectionForm preExamReflectionForm) {
        this.preExamReflectionForm = preExamReflectionForm;
    }
    ...
    */
    ...
    protected Exam(Parcel in) {
        ...
        byte tmpEnableMindsetReflections = in.readByte();
        enableMindsetReflections = tmpEnableMindsetReflections == 0 ? null : tmpEnableMindsetReflections == 1;
        Long reflectionFormId = null;
        if (in.readByte() != 0) {
            reflectionFormId = in.readLong();
        }
        byte tmpReflectionFormMandatory = in.readByte();
        Boolean reflectionFormMandatory = tmpReflectionFormMandatory == 0 ? null : tmpReflectionFormMandatory == 1;
        if (reflectionFormId != null || reflectionFormMandatory != null) {
            preExamReflectionForm = new ReflectionForm(reflectionFormId, reflectionFormMandatory);
        } else {
            preExamReflectionForm = null;
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) (enableMindsetReflections == null ? 0 : enableMindsetReflections ? 1 : 2));
        Long reflectionFormId = preExamReflectionForm != null ? preExamReflectionForm.getId() : null;
        Boolean reflectionFormMandatory = preExamReflectionForm != null ? preExamReflectionForm.getSubmissionMandatory() : null;
        if (reflectionFormId == null) {
            dest.writeByte((byte) 0);
        } else {
            dest.writeByte((byte) 1);
            dest.writeLong(reflectionFormId);
        }
        dest.writeByte((byte) (reflectionFormMandatory == null ? 0 : reflectionFormMandatory ? 1 : 2));
    }
