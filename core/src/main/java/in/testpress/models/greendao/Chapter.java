...
public class Chapter {
    ...
    public Integer getRawChildrenCount(Context context) {
        ...
        return (int) chapterDao.queryBuilder().where(ChapterDao.Properties.ParentId.eq(getId())).count();
    }
    ...
    public Integer getRawContentsCount(Context context) {
        ...
        return (int) contentDao.queryBuilder().where(ContentDao.Properties.ChapterId.eq(getId())).count();
    }
    // KEEP METHODS END
