...
object RoomMigration4To5 {
    ...
    val MIGRATION_4_5: Migration = object : Migration(4, 5) {
        override fun migrate(database: SupportSQLiteDatabase) {
            database.execSQL(getProductEntityTableCreationSQL())
            database.execSQL(getCourseEntityTableCreationSQL())
            database.execSQL(getProductCourseEntityTableCreationSQL())
        }

    }

    private fun getProductEntityTableCreationSQL(): String {
    ...
    private fun getCourseEntityTableCreationSQL(): String {
        return  "CREATE TABLE IF NOT EXISTS " +
    ...
    private fun getProductCourseEntityTableCreationSQL(): String {
