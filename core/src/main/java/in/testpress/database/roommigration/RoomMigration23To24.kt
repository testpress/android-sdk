...
object RoomMigration23To24 {
    val MIGRATION_23_24: Migration = object : Migration(23, 24) {
        override fun migrate(database: SupportSQLiteDatabase) {
            ...
            database.execSQL("CREATE TABLE IF NOT EXISTS `OfflineAttempt` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `date` TEXT NOT NULL, `totalQuestions` INTEGER NOT NULL, `lastStartedTime` TEXT NOT NULL, `remainingTime` TEXT NOT NULL, `timeTaken` TEXT NOT NULL, `state` TEXT NOT NULL, `lastViewedQuestionId` INTEGER NOT NULL, `attemptType` INTEGER NOT NULL)")
