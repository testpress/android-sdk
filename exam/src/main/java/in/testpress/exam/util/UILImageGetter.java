            ...
            container.post(new Runnable() {
                ...
                public void run() {
                    if (null != loadedImage) {
                        ...
                        Log.d("UILImageGetter", "New Width " + newWidth);
                        Log.d("UILImageGetter", "New Height " + newHeight);
                        Drawable result = new BitmapDrawable(activity.getApplicationContext()
                        ...
                        Log.d("UILImageGetter", "Container Height " + container.getHeight());
                        Log.d("UILImageGetter", "B4 finalContainer Height " + finalContainerHeight);
                        if (0 != finalContainerHeight) {
                            finalContainerHeight += newHeight;
                        } else {
                            finalContainerHeight = container.getHeight() + newHeight;
                        }
                        Log.d("UILImageGetter", "finalContainer Height " + finalContainerHeight);
