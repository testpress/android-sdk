...
class IndividualSubjectAnalyticsGraphAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.testpress_individual_subject_analytics_graph_list_item, parent, false);
    ...
    private PieData getBarData(Subject subject) {
        ...
        colors.add(ContextCompat.getColor(context, R.color.testpress_green_light));
        colors.add(ContextCompat.getColor(context, R.color.testpress_red_incorrect));
        colors.add(ContextCompat.getColor(context, R.color.testpress_yellow));
