...
public class TestpressSDKDaoGenerator {
    ...
    private static final int VERSION = 87;
    ...
    public static void main(String args[]) throws Exception {
        ...
        content.addBooleanProperty("hasArtifacts")
                .codeBeforeField("@SerializedName(\"has_artifacts\")");
        content.addStringProperty("artifactsUrl")
                .codeBeforeField("@SerializedName(\"artifacts_url\")");
    ...
    private static Entity addAttachment(Schema schema) {
        ...
        attachment.addBooleanProperty("allowDownload");
    ...
    private static Entity addLiveStream(Schema schema) {
        ...
        liveStream.addStringProperty("provider");
        liveStream.addStringProperty("fermionUrl");
        return liveStream;
    }
