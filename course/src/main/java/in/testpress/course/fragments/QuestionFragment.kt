...
class QuestionFragment : Fragment() {
    ...
    private fun initializeListeners() {
        submitButton.setOnClickListener {
            ...
            submitButton.background.setColorFilter(getResources().getColor(R.color.testpress_text_gray_medium), PorterDuff.Mode.SRC_ATOP)
    ...
    inner class OptionsSelectionListener {
        ...
        fun onTextValueChange(value: String) {
            // userSelectedAnswer.shortText = value.trim()
        }
    }
}
