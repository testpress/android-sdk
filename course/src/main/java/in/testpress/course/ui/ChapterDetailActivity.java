...
public class ChapterDetailActivity extends BaseToolBarActivity {
    ...
    public void onBackPressed() {
        ...
        if (instituteSettings.isCoursesFrontend() &&
                instituteSettings.isCoursesGamificationEnabled()) {
            if (fragment instanceof  ContentsListFragment) {
                super.onBackPressed();
                return;
            }
        }

        if (fragment instanceof ChaptersListFragment) {
            ...
            if (chaptersListFragment.parentChapterId.equals("null")) {
                ...
                chaptersListFragment.displayChildChapters(getParentChapterId(chaptersListFragment.parentChapterId));
            }
