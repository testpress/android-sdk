...
public class ExpandableContentsActivity extends BaseToolBarActivity {
    ...
    public void handleError(TestpressException exception) {
    ...
    public QueryBuilder<Chapter> getAllChaptersQueryBuilder() {
        return chapterDao.queryBuilder().where(ChapterDao.Properties.CourseId.eq(course.getId()));
    }

    public void displayError(int title, int description, int imageRes) {
    ...
    public void setEmptyText(int title, int description, int imageRes) {
