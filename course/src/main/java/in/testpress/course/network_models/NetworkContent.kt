package `in`.testpress.course.network_models
...
fun NetworkContent.asDomainmModel(): DomainContent {
...
fun NetworkContent.asDatabaseModel(): Content {
    return Content(
            id=this.id,
            title=this.title,
            description=this.description,
...
fun NetworkContent.asGreenDaoModel(): `in`.testpress.models.greendao.Content {
    return `in`.testpress.models.greendao.Content(
            this.order,
