...
class PinchToZoomGesture(
    activity: Activity,
    playerViewMainFrameLayout: FrameLayout
    ...
    private val zoomModeText: TextView = playerViewMainFrameLayout.findViewById(R.id.zoom_mode_text)
    private val zoomSizeText: TextView = playerViewMainFrameLayout.findViewById(R.id.zoom_size_text)
    private val playerView: DoubleTapPlayerView = playerViewMainFrameLayout.findViewById(R.id.exo_player_view)
