...
public final class TrackSelectionDialog extends DialogFragment {
    ...
    public static TrackSelectionDialog createForTrackSelector(
            final DefaultTrackSelector trackSelector, DialogInterface.OnDismissListener onDismissListener) {
        final MappedTrackInfo mappedTrackInfo =
    ...
    public List<SelectionOverride> getOverrides(int rendererIndex) {
        TrackSelectionViewFragment rendererView = tabFragments.get(rendererIndex);
        List<SelectionOverride> stringList = Collections.emptyList();
        return rendererView == null ? stringList : rendererView.overrides;
    }
    ...
    public View onCreateView(
        ...
        tabLayout.setTabTextColors(Color.parseColor("#777777"), Color.parseColor("#ffffff"));
    ...
    public static final class TrackSelectionViewFragment extends Fragment
        ...
        public void init(
            ...
            List<SelectionOverride> emptyList = Collections.emptyList();
            this.overrides =
