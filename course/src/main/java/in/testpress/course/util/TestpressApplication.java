...
public class TestpressApplication extends Application {
    ...
    private static final String TAG = "TestpressApplication";
    ...
    public void onCreate() {
        super.onCreate();
        userAgent = Util.getUserAgent(this, "Testpress");
    }
    ...
    private synchronized void initDownloadManager() {
        if (downloadManager == null) {
            ...
            downloadTracker =
                    new DownloadTracker(this, buildDataSourceFactory(), downloadManager);
        }
    }

    private void upgradeActionFile(
            String fileName, DefaultDownloadIndex downloadIndex,
