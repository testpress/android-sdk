...
class PdfWebViewCacheTest {
    ...
    fun initShouldSucceedWithValidContext() {
        val result = PdfWebViewCache.init(context)
        assertTrue(result)
    }

    @Test
    fun initShouldHandleNullContext() {
        val result = PdfWebViewCache.init(null)
        assertFalse(result)
    }

    @Test
    fun initShouldBeIdempotent() {
        val result1 = PdfWebViewCache.init(context)
        val result2 = PdfWebViewCache.init(context)
    ...
    fun acquireShouldCreateNewWebViewForNewContentId() {
        val webView = PdfWebViewCache.acquire(1L, "https://example.com/pdf1.pdf") { }
    ...
    fun acquireShouldReturnCachedWebViewForSameContentId() {
        ...
        val webView2 = PdfWebViewCache.acquire(1L, "https://example.com/pdf1.pdf") { }
    ...
    fun acquireShouldCreateDifferentWebViewsForDifferentContentIds() {
        val webView1 = PdfWebViewCache.acquire(1L, "https://example.com/pdf1.pdf") { }
        val webView2 = PdfWebViewCache.acquire(2L, "https://example.com/pdf2.pdf") { }
    ...
    fun isCachedShouldReturnFalseForNewContent() {
        val cached = PdfWebViewCache.isCached(99L, "https://example.com/new.pdf")
        assertFalse(cached)
    }

    @Test
    fun isCachedShouldReturnTrueForCachedContent() {
        PdfWebViewCache.acquire(1L, "https://example.com/pdf1.pdf") { }
        
        val cached = PdfWebViewCache.isCached(1L, "https://example.com/pdf1.pdf")
        assertTrue(cached)
    }
    ...
    fun isCachedShouldReturnFalseForDifferentUrl() {
        ...
        val cached = PdfWebViewCache.isCached(1L, "https://example.com/different.pdf")
        assertFalse(cached)
    }
    ...
    fun lruEvictionShouldRemoveOldestWebView() {
        val webView1 = PdfWebViewCache.acquire(1L, "https://example.com/pdf1.pdf") { }
        val webView2 = PdfWebViewCache.acquire(2L, "https://example.com/pdf2.pdf") { }
        val webView3 = PdfWebViewCache.acquire(3L, "https://example.com/pdf3.pdf") { }
        val webView4 = PdfWebViewCache.acquire(4L, "https://example.com/pdf4.pdf") { }
        
        // Oldest (1L) should be evicted
        assertFalse(PdfWebViewCache.isCached(1L, "https://example.com/pdf1.pdf"))
        assertTrue(PdfWebViewCache.isCached(2L, "https://example.com/pdf2.pdf"))
        assertTrue(PdfWebViewCache.isCached(3L, "https://example.com/pdf3.pdf"))
        assertTrue(PdfWebViewCache.isCached(4L, "https://example.com/pdf4.pdf"))
    }
    ...
    fun lruAccessShouldUpdateOrder() {
        ...
        assertTrue(PdfWebViewCache.isCached(1L, "https://example.com/pdf1.pdf"))
        assertFalse(PdfWebViewCache.isCached(2L, "https://example.com/pdf2.pdf"))
        assertTrue(PdfWebViewCache.isCached(3L, "https://example.com/pdf3.pdf"))
        assertTrue(PdfWebViewCache.isCached(4L, "https://example.com/pdf4.pdf"))
    }
    ...
    fun attachShouldNotCrashWithNullParent() {
        ...
        assertDoesNotThrow {
            PdfWebViewCache.attach(container, webView)
        }
    }
    ...
    fun attachShouldRemoveWebViewFromPreviousParent() {
        ...
        PdfWebViewCache.attach(container1, webView)
        PdfWebViewCache.attach(container2, webView)
    ...
    fun clearAllShouldRemoveAllCachedWebViews() {
        PdfWebViewCache.acquire(1L, "https://example.com/pdf1.pdf") { }
        PdfWebViewCache.acquire(2L, "https://example.com/pdf2.pdf") { }
        PdfWebViewCache.acquire(3L, "https://example.com/pdf3.pdf") { }
        ...
        assertFalse(PdfWebViewCache.isCached(1L, "https://example.com/pdf1.pdf"))
        assertFalse(PdfWebViewCache.isCached(2L, "https://example.com/pdf2.pdf"))
        assertFalse(PdfWebViewCache.isCached(3L, "https://example.com/pdf3.pdf"))
    }
    ...
    fun acquireWithDifferentUrlShouldReloadSameWebView() {
        val webView1 = PdfWebViewCache.acquire(1L, "https://example.com/pdf1.pdf") { }
        val webView2 = PdfWebViewCache.acquire(1L, "https://example.com/different.pdf") { }
